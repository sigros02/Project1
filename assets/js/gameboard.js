...
// // const imageURLprompt = prompt("Please enter the URL of the image you would like to use.");
// // const btnTokenLetter = document.querySelector('#useTokenLetter');
// // const tokenLetter = prompt("Please enter the letter you would like to use for your token.");
...
//   // tempStorageObject = localStorage.getItem('moodBoardData');
...
//       textEl.style.left = text.left;
//       textEl.style.top = text.top;
//       textEl.classList.add("draggable");
//       moodBoardEl.appendChild(textEl);
//     }
//   }
// }
